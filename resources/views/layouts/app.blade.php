...
<body class="bg-gray-200 min-h-screen leading-none">
    @if (session('estado'))
        <div class="bg-gray-700 p-8 text-center text-white font-bold uppercase">
            {{session('estado')}}
        </div>
    @endif
    <div id="app">
                ...
                <div class="flex items-center justify-around">
                    ...
                    <nav class="flex-1 text-right">
                        ...
                        @else
                            ...
                            <a href="{{ route('notificaciones') }}" class="bg-gray-500 rounded-full mt-2 px-3 py-2 font-bold text-sm text-white">{{ Auth::user()->unreadNotifications->count()}}</a>
