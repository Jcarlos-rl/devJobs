...
<div class="container mx-auto">
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white boder borde-2 shadow-md mt-20">
                <div class="bg-gray-100 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    {{ __('Login') }}
                </div>
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm text-gray-500 text-center w-full" href="{{ route('password.request') }}">
